...
- 2026-09-22 07:30: the owner's tester record (lachlan.mia.chan@gmail.com) was added to `LazyOracle Internal` and `LazyOracle Public Beta`; internal groups only email people who are in the group, which is why no TestFlight mail had arrived.
