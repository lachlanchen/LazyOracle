...
final class ChatStore {
    ...
    - Face and palm tools describe observable proportions only. Do not infer personality, health, wealth, relationships or future events from appearance. Traditional labels are symbolic conventions. Respect uncertain or mixed categories, and never invent undetected palm lines, mounts or a hairline.
